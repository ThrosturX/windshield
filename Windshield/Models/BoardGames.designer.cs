...
namespace Windshield.Models
{
    ...
    partial void OnendDateChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ownerName", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnuserNameOneChanging(string value);
    partial void OnuserNameOneChanged();
    partial void OnuserNameTwoChanging(string value);
    partial void OnuserNameTwoChanged();
    ...
    partial void OndateFriendedChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_userNameOne", DbType="NVarChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string userNameOne
		{
			get
			{
				return this._userNameOne;
			}
			set
			{
				if ((this._userNameOne != value))
				{
					if (this._User.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnuserNameOneChanging(value);
					this.SendPropertyChanging();
					this._userNameOne = value;
					this.SendPropertyChanged("userNameOne");
					this.OnuserNameOneChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_userNameTwo", DbType="NVarChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string userNameTwo
		{
			get
			{
				return this._userNameTwo;
			}
			set
			{
				if ((this._userNameTwo != value))
				{
					if (this._User1.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnuserNameTwoChanging(value);
					this.SendPropertyChanging();
					this._userNameTwo = value;
					this.SendPropertyChanged("userNameTwo");
					this.OnuserNameTwoChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Friend", Storage="_User", ThisKey="userNameOne", OtherKey="UserName", IsForeignKey=true)]
		public User User
		{
			get
			{
			...
			set
			{
							...
							|| (this._User.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._userNameOne = value.UserName;
					}
					else
					{
						this._userNameOne = default(string);
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Friend1", Storage="_User1", ThisKey="userNameTwo", OtherKey="UserName", IsForeignKey=true)]
		public User User1
		{
			get
			{
			...
			set
			{
							...
							|| (this._User1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._userNameTwo = value.UserName;
					}
					else
					{
						this._userNameTwo = default(string);
					}
    ...
    partial void OndateJoinedChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_GroupMember", Storage="_User", ThisKey="userName", OtherKey="UserName", IsForeignKey=true)]
		public User User
		{
			get
			{
    ...
    partial void OnnameChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_UserDetail", Storage="_User", ThisKey="userName", OtherKey="UserName", IsForeignKey=true)]
		public User User
		{
			get
			{
	...
	public partial class UserRating : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _userNameRater;
		
		private string _userNameRated;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnuserNameRaterChanging(string value);
    partial void OnuserNameRaterChanged();
    partial void OnuserNameRatedChanging(string value);
    partial void OnuserNameRatedChanged();
    ...
    partial void OndateReviewedChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_userNameRater", DbType="NVarChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string userNameRater
		{
			get
			{
				return this._userNameRater;
			}
			set
			{
				if ((this._userNameRater != value))
				{
					if (this._User.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnuserNameRaterChanging(value);
					this.SendPropertyChanging();
					this._userNameRater = value;
					this.SendPropertyChanged("userNameRater");
					this.OnuserNameRaterChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_userNameRated", DbType="NVarChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string userNameRated
		{
			get
			{
				return this._userNameRated;
			}
			set
			{
				if ((this._userNameRated != value))
				{
					if (this._User1.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnuserNameRatedChanging(value);
					this.SendPropertyChanging();
					this._userNameRated = value;
					this.SendPropertyChanged("userNameRated");
					this.OnuserNameRatedChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_UserRating", Storage="_User", ThisKey="userNameRater", OtherKey="UserName", IsForeignKey=true)]
		public User User
		{
			get
			{
			...
			set
			{
							...
							|| (this._User.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._userNameRater = value.UserName;
					}
					else
					{
						this._userNameRater = default(string);
					}
					this.SendPropertyChanged("User");
				}
			}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_UserRating1", Storage="_User1", ThisKey="userNameRated", OtherKey="UserName", IsForeignKey=true)]
		public User User1
		{
			get
			{
			...
			set
			{
							...
							|| (this._User1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._userNameRated = value.UserName;
					}
					else
					{
						this._userNameRated = default(string);
					}
					this.SendPropertyChanged("User1");
				}
			}
    ...
    partial void OnLastActivityDateChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Friend", Storage="_Friends", ThisKey="UserName", OtherKey="userNameOne")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Friend1", Storage="_Friends1", ThisKey="UserName", OtherKey="userNameTwo")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_GroupMember", Storage="_GroupMembers", ThisKey="UserName", OtherKey="userName")]
		public EntitySet<GroupMember> GroupMembers
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_UserDetail", Storage="_UserDetail", ThisKey="UserName", OtherKey="userName", IsUnique=true, IsForeignKey=false)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_UserRating", Storage="_UserRatings", ThisKey="UserName", OtherKey="userNameRater")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_UserRating1", Storage="_UserRatings1", ThisKey="UserName", OtherKey="userNameRated")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_GameRating", Storage="_GameRatings", ThisKey="UserName", OtherKey="userName")]
		public EntitySet<GameRating> GameRatings
		{
			get
			{
    ...
    partial void OntimesPlayedChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_GameRating", Storage="_User", ThisKey="userName", OtherKey="UserName", IsForeignKey=true)]
		public User User
		{
			get
			{
